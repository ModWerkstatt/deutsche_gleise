function data()
	...
	t.speedLimit = 250.0 / 3.6
	t.speedCoeffs = { .85, 30.0, .8 }		-- curve speed limit = a * (radius + b) ^ c
	...
	t.bumperModel = "railroad/bumper/bock3b.mdl"
	t.switchSignalModel = "weichenantrieb/switch_new.mdl"

	t.fillGroundTex = "ballast_fill.lua"
	t.borderGroundTex = "ballast.lua"
	
	t.railModel ="railroad/tracks/single_rail.mdl"
	t.sleeperModel = "railroad/tracks/beton_b70/b70_single_sleeper_high_speed.mdl"
	t.trackStraightModel = {
		"railroad/tracks/beton_b70/b70_2m_high_speed.mdl",
		"railroad/tracks/beton_b70/b70_4m_high_speed.mdl",
		"railroad/tracks/beton_b70/b70_8m_high_speed.mdl",
		"railroad/tracks/beton_b70/b70_16m_high_speed.mdl",
	}

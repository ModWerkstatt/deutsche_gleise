function data()
	...
	t.sleeperModel = "railroad/tracks/beton_b6/b6_single_sleeper_high_speed.mdl"
	t.trackStraightModel = {
		"railroad/tracks/beton_b6/b6_2m_high_speed.mdl",
		"railroad/tracks/beton_b6/b6_4m_high_speed.mdl",
		"railroad/tracks/beton_b6/b6_8m_high_speed.mdl",
		"railroad/tracks/beton_b6/b6_16m_high_speed.mdl",
	}
